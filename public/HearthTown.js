class HearthTown {
    ...
    newMap(mapName) {
        ...
        if (!this.flag && mapName.lowerMapSrc == "/images/maps/protag.png"){
            let music = document.getElementById("music");
            music.volume = 0.25;
            music.play();
            this.flag = true;
        ...
        if (!this.flags.zeph && mapName.lowerMapSrc == "/images/maps/zeph.png"){
        ...
        if (this.flags.hasMap && !this.flags.food && mapName.lowerMapSrc == "/images/maps/zeph.png"){
            this.map.cutscene([
        ...
        if (this.flags.veeNote && this.flags.hasMap){
            music.volume = 0.25;
            if (music.src != "eastrocks.ogg"){
                music.src = "eastrocks.ogg";
            }
        }
        if (this.flags.veeNote && !this.flags.hasMap){
            music.volume = 0.25;
            if (music.src != "winds.ogg"){
                music.src = "winds.ogg";
            }
        }
