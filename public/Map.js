            ...
            if (look.flag){
                if (look.flag.food){
                    if (this.world.flags.hasMap){
                        ...
                        this.lowerMap.src = "images/maps/daniFood.png"
...
window.Maps = {
    HearthTown: {
        lowerMapSrc: '/images/maps/Hearth.png',
        upperMapSrc: '/images/maps/Empty.png',
        walls: {
    ...
    protagCabin:{
        lowerMapSrc:"/images/maps/protag.png",
        upperMapSrc:"/images/maps/empty.png",
        walls:{
    ...
    zephCabin:{
        lowerMapSrc:"/images/maps/zeph.png",
        upperMapSrc:"/images/maps/empty.png",
        walls:{
            [utils.asGridCoord(-1,0)]:"pre",
            [utils.asGridCoord(-1,1)]:"pre",
        ...
        zeph: new ComplexEntity({
            ...
            starty: utils.withGrid(7),
            src: '/images/characters/zeph.png',
            height: 16,
            width: 16,
            animations: {
                "default": [[16, 0]],
    ...
    emCabin:{
        lowerMapSrc:"/images/maps/em.png",
        upperMapSrc:"/images/maps/empty.png",
        walls:{
            [utils.asGridCoord(-1,0)]:"pre",
            [utils.asGridCoord(-1,1)]:"pre",
    ...
    daniCabin:{
        lowerMapSrc:"/images/maps/dani.png",
        upperMapSrc:"/images/maps/empty.png",
        walls:{
            [utils.asGridCoord(-1,3)]:"pre",
            [utils.asGridCoord(-1,4)]:"pre",
        ...
        dani: new ComplexEntity({
            ...
            src: '/images/characters/dani.png',
            height: 16,
            width: 16,
            animations: {
               "default": [[16, 0]],
    ...
    veeCabin:{
        lowerMapSrc:"/images/maps/vee.png",
        upperMapSrc:"/images/maps/empty.png",
        entities:{protag : new ComplexEntity({
            x: utils.withGrid(0),
            y: utils.withGrid(3),
    ...
    tutorial:{
        lowerMapSrc:"/images/maps/tut.png",
        upperMapSrc:"/images/maps/Empty.png",
        walls:{
    ...
    final:{
        lowerMapSrc:"/images/maps/final.png",
        upperMapSrc:"/images/maps/Empty.png",
        entities:{protag : new ComplexEntity({
            x: utils.withGrid(4),
            y: utils.withGrid(7),
    ...
    fin:{
        lowerMapSrc:"/images/maps/fin.png",
        upperMapSrc:"/images/maps/fin.png",
        entities:{protag : new ComplexEntity({
            x: utils.withGrid(4),
            y: utils.withGrid(4),
            startx: utils.withGrid(4),
